...
//    /// </remarks>
//    public enum CAlternatingRowBackground
//    {
//        /// <summary>
...
//    /// </code>
//    /// </example>
//    public class CListView : BindableElement, ISerializationCallbackReceiver
//    {
//        /// <summary>
...
//            private readonly UxmlEnumAttributeDescription<CAlternatingRowBackground> m_ShowAlternatingRowBackgrounds = new UxmlEnumAttributeDescription<CAlternatingRowBackground> { name = "show-alternating-row-backgrounds", defaultValue = CAlternatingRowBackground.None };
...
//        [SerializeField] private CAlternatingRowBackground m_ShowAlternatingRowBackgrounds = CAlternatingRowBackground.None;

//        /// <summary>
//        /// This property controls whether the background colors of ListView rows alternate.
//        /// Takes a value from the <see cref="CAlternatingRowBackground"/> enum.
//        /// </summary>
//        /// <remarks>
//        /// The default value is <see cref="CAlternatingRowBackground.None"/>.
//        /// </remarks>
//        public CAlternatingRowBackground showAlternatingRowBackgrounds
//        {
...
//        public CListView(IList itemsSource, int itemHeight, Func<VisualElement> makeItem, Action<VisualElement, int> bindItem) : this()
//        {
...
//            if (showAlternatingRowBackgrounds != CAlternatingRowBackground.None && newIndex % 2 == 1)
...
//            if (showAlternatingRowBackgrounds != CAlternatingRowBackground.All || backgroundFillHeight <= 0)
//            {
